...
class Mywin(wx.Frame):
    def __init__(self, parent, title):
        ...
        l4 = wx.StaticText(panel, -1, "hh")

        hbox4.Add(l4, 1, wx.EXPAND | wx.ALIGN_LEFT | wx.ALL, 5)
        self.t4 = wx.TextCtrl(panel, value="xx", style=wx.TE_READONLY | wx.TE_CENTER)
...
app = wx.App()
Mywin(None, 'TextCtrl-www.yiibai.com')
app.MainLoop()